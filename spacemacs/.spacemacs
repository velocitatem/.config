...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   spacemacs--cur-theme 'dichromacy
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq
    ...
    ;; Superstar item bullet alist for org-mode
    org-superstar-item-bullet-alist '((42 . 8226) (43 . 9501) (45 . 8211))

    ;; Terminal command for 'terminal-here' on Linux
    terminal-here-linux-terminal-command 'xfce4-terminal

    ;; Alert default style
    alert-default-style 'libnotify

    ;; Screenshot method for org-download
    org-download-screenshot-method "spectacle -r -b -C -o %s"
...
before packages are loaded."
  ...
  (load "/mnt/s/Documents/Projects/fabric.el/fabric.el")
  ...
  (spacemacs/set-leader-keys
    "aorD" 'org-roam-dailies-capture-today
    "aorn" 'org-id-get-create
    "bk" 'kill-this-buffer
    "ag" 'gptel
    "aG" 'gptel-send
    )
